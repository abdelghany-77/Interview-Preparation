...
function renderQuestions(questionsToRender = questions) {
  ...
  categories.forEach((category) => {
    groupedQuestions[category] = questionsToRender.filter(
      ...
      groupedQuestions[category].forEach((q) => {
        ...
        questionCard.innerHTML = `
          ...
          <div class="approach-section">
            <h4><i class="fas fa-lightbulb"></i> Approach</h4>
            <p>${q.approach}</p>
          </div>
          ...
          <div class="answer-section">
            ...
            <div class="answer-text">
              <div class="example-code">${escapeHtml(q.answer)}</div>
            </div>
          </div>
        `;
...
// Initialize theme and render questions
initTheme();
renderQuestions();
